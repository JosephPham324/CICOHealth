...
<html>
    <head>
        ...
        <link rel="stylesheet" href = "${pageContext.request.contextPath}/Assets/scss/main/General/healthinfo.css"/>
        ...
        <title>Health Info | ${initParam['webappName']}</title>
    </head>
    <body>
        <section style="background-image: url('${pageContext.request.contextPath}/Assets/image/healthinfo.jpg');">
