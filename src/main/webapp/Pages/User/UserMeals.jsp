...
<html lang="en">
    <head>
        ...
        <link
            ...
            />
        <%@ include file = "../General/headfootlink.jsp"%>
        <title>${sessionScope.username}'s Meals | ${initParam['webappName']}</title>
    </head>
    <body>
        <%@ include file="../General/header.jsp" %>
        <c:if test="${sessionScope.userID == null}">
            <c:redirect url="${pageContext.request.contextPath}/search-food"></c:redirect>
        </c:if>
        <jsp:useBean
            id="mDAO"
            class="DAO.MealDAO"
            ...
            <div class="edit-form">
                ...
                <div class="create-meal">
                    <form action="${pageContext.request.contextPath}/home-control" id="mealForm" method="post" onsubmit="return ${sessionScope.userID!=null}">
                    <fieldset>
                        ...
                        <c:forEach items="${meals}" var="item" varStatus="loop">
                            ...
                            <c:set var="sumCarb" value="${sumCarb+item.getCarbWeight()}"></c:set>
                                ...
                                <c:set var="previousDate" value="${currentDate}"></c:set>
                                    ...
                                    |
                                    <form action="${pageContext.request.contextPath}/home-control" method="post" class="delete-item-form"
