...
<html lang="en">
    ...
    <body>
        ...
        <c:if test="${sessionScope.userID == null}">
            <c:redirect url="${pageContext.request.contextPath}/search-exercise"></c:redirect>
        </c:if>
        <jsp:useBean
            id="eDAO"
            ...
            <div class="edit-form">
                ...
                <form action="${pageContext.request.contextPath}/home-control" method = "post" id = "editForm">
