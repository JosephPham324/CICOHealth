      ...
      <div class="col-sm-10 row g-0 info tab-content" id="pills-tabContent">
        <div class="login-info active" id="login-info">
          ...
          <div class="field">
            ...
            <span class="field-value" id="username-value">QuangPNCE170036</span>
            <button class="edit"><i class="fa-solid fa-pen-to-square edit-button"></i></button>
          </div>
          <div class="field">
            <div class="label">Password:</div>
            <span class="field-value hidden" id="password-value">group4prj301</span>
            <span id="toggle-password-visibility"><i class="fa fa-eye-slash" aria-hidden="true"></i></span>
            <button class="edit"><i class="fa-solid fa-pen-to-square edit-button"></i></button>
          </div>
          <!-- <div class="field">
            <div class="label">Email:</div>
            <span class="field-value" id="email-value">QuangPNCE170036@fpt.edu.vn</span>
            <button class="edit"><i class="fa-solid fa-pen-to-square edit-button"></i></button>
          </div> -->
        </div>
